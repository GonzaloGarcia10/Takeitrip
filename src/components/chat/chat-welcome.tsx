...
import { MessageSquare, MapPin, Hotel, Compass, Sparkles, ArrowRight, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-16">
      ...
      >
        ...
        <Link
          href="/destinos"
          className="inline-flex items-center gap-2 rounded-xl border border-white/20 px-5 py-2.5 text-sm font-medium text-white/70 transition-all hover:bg-white/5 hover:text-white hover:border-white/30"
        >
      ...
      {!showSuggestions && (
        <motion.button
          ...
          className="mt-12 flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 px-5 py-3 text-sm text-white/50 transition-all hover:bg-white/10 hover:text-white/70"
        >
          <span>Ver ejemplos de búsqueda</span>
